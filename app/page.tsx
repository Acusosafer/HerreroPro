...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Navbar />
      <main className="flex-1 container py-8 flex items-center justify-center mt-16">
        <Card className="w-full max-w-md card-hover-effect mobile-card">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Ingrese sus credenciales para acceder a HerreroPRO
            </CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="text-sm text-center text-muted-foreground mobile-text">
